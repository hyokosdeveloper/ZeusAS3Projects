...
:: Android packaging
set AND_CERT_NAME="iViewLoginModule"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\iViewLoginModule.p12
...
set IOS_PROVISION=cert\iViewLoginModule.mobileprovision
...
set APP_ID=air.iViewLoginModule

:: Output packages
set DIST_PATH=dist
set DIST_NAME=iViewLoginModule
