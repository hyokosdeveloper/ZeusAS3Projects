...
:: Android packaging
set AND_CERT_NAME="EcommerceApp"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\EcommerceApp.p12
...
set IOS_PROVISION=cert\EcommerceApp.mobileprovision
...
set APP_ID=air.EcommerceApp

:: Output packages
set DIST_PATH=dist
set DIST_NAME=EcommerceApp
